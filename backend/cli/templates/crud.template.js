...
function generateCreateContent(modelNameSingular, modelNamePlural) {
   return `
    ...
    class ${capitalizeFirstLetter(modelNamePlural)}Creator extends SequelizeCreator<I${capitalizeFirstLetter(modelNameSingular)}> {
...
function generateDeleteContent(modelNameSingular, modelNamePlural) {
   return `
    ...
    class ${capitalizeFirstLetter(modelNamePlural)}Deleter extends SequelizeDeleter {
    model = ${capitalizeFirstLetter(modelNameSingular)};
    entityName = ${toSnakeCase(modelNameSingular)}.SINGULAR;
    }
...
function generatePatchContent(modelNameSingular, modelNamePlural) {
   return `
    ...
    class ${capitalizeFirstLetter(modelNamePlural)}Patcher extends SequelizePatcher<I${capitalizeFirstLetter(modelNameSingular)}> {
    model = ${capitalizeFirstLetter(modelNameSingular)};
    entityName = ${toSnakeCase(modelNameSingular)}.SINGULAR;
    }
...
function generateUpdateContent(modelNameSingular, modelNamePlural) {
   return `
    ...
    class ${capitalizeFirstLetter(modelNamePlural)}Updater extends SequelizeUpdater<I${capitalizeFirstLetter(modelNameSingular)}> {
    model = ${capitalizeFirstLetter(modelNameSingular)};
    entityName = ${toSnakeCase(modelNameSingular)}.SINGULAR;
    }

...
export const themesConfig: FuseThemesType = {
  default: {
    palette: {
      ...
      text: {
        primary: '#FFFFFF',
        secondary: '#A3A3A3', // Gris claro para textos secundarios
      },
      common: {
        black: '#000000',
        white: '#FFFFFF',
      ...
      primary: {
        light: '#5F5F5F', // Gris claro
        main: '#1F1F1F', // Gris oscuro como color principal
        dark: '#000000', // Negro puro
        contrastText: '#FDC700',
      },
      secondary: {
        light: '#FFE066', // Amarillo suave
        main: '#FDC700', // Amarillo institucional
        dark: '#B78B00', // Amarillo dorado profundo
        contrastText: '#000000',
      },
      background: {
        paper: '#1C1C1C',
